module sys_re_input_header
    ...
    type,public::sys_re_input
       ...
       real xf,xg,xs,xos,acf,height,f,Tin,pout,flowin,sigma,sigmab,alpha
       real Ti,ui,pi
    contains
    ...
    contains
     subroutine set_inputdata(this)
      ...
      class(sys_re_input)::this
       ...
       read(1,*) this%xf,this%xg,this%xs,this%xos,this%acf,this%height,this%npin,this%nf,this%ng,this%ns,this%ny,this%f,this%Tin,this%pout,this%flowin,this%sigma,this%sigmab,this%alpha,this%Ti,this%ui,this%pi
       close(1)
